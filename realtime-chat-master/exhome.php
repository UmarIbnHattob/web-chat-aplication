...
<head>
    ...
    <title class="text-warning">Assalamu Alaikum - Home</title>
    <style>
    body
    {
      height: 100%;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand " href="#">
        <img src="img/logo.png" class="rounded-circle" width="35" height="35" class="d-inline-block align-top" alt="Logo">
        Assalamu Alaikum 
      </a>
