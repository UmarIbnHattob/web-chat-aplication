...
<head>
  ...
  <title class="text-warning">Home | Assalamu Alaikum</title>
...
<div class="container-fluid">
    ...
    <img src="img/logo.png" class="rounded-circle" width="80" height="80" class="d-inline-block align-top" alt="Logo">
      <b>Assalamu Alaikum Messenger</b> 
    </a>
    ...
    <div class="carousel-inner" role="listbox">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption">
            <div class="container">
            <h2 class="h2-responsive text-warning">Assalamu Alaikum Messenger</h2>
            <p>This beautiful website is created by Azizbek Jumanazarov</p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption">
          <h2 class="h2-responsive text-dark">User Profile Creation</h2>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption">
          <h2 class="h2-responsive text-warning">Real Time Group Chatting</h2>
  ...
  <div class="card w-100">
    ...
    <h5 class="card-title">Introducing,</h5>
      <h2 class="card-title text-warning">Assalamu Alaikum Messenger</h2>
      <p class="card-text">
        <ul>
  ...
  <div class="col-sm-6 pt-4">
    <div class="card">
      <div class=" p-4">
        ...
        <a href="find.php" class="btn btn-warning">Find Friends</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6 pt-4">
    <div class="card">
      <div class=" p-4">
        ...
        <a href="init.php" class="btn btn-warning">Create Group</a>
      </div>
    </div>
  </div>
</div>
  ...
  <h3 class="text-center">About Us</h3>
    <div class="row mt-3">
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
        <div>
          <img alt="developer" style="clip-path: circle(45%);" class="col-md-7 col-lg-6 ml-auto mr-auto d-flex align-items-center" src="img/logo.png"  />
        </div>
      </div>
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
        <div class="pl-3 pr-2">
          <h5 class="card-title text-warning">Assalamu Alaikum Messenger</h5>
          ...
          <a href="profile.php" class="btn btn-primary mt-2 mr-2">My Profile</a>
          <a href="find.php" class="btn mt-2 mr-2 btn-warning">Find Friends</a>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-5 mb-4">
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
        <div>
        <div class="pl-3 pr-2">
          <h5 class="card-title text-warning">Azizbek Jumanazarov</h5>
          <p class="text-muted text-warning">Developer - Assalamu Alaikum Messenger</p>
          ...
          <a href="https://github.com/UmarIbnHattob/UmarIbnHattob.git" class="btn btn-primary mt-2 mr-2">About Me</a>
          <a href="https://github.com/yogeshgiri904" class="btn mt-2 mr-2 btn-warning">Projects</a>
        </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
      <img alt="developer" style="clip-path: circle(45%);" class="col-md-7 col-lg-6 ml-auto mr-auto d-flex align-items-center" src="img/Azizbek.jpg"  />
...
<footer class="bg-dark text-center text-white">
  ...
  <div class="container p-4">
    ...
    <section class="mb-4">
      ...
      ASSALAMU ALAIKUM CHATTING APPLICATION
      </h4>
  ...
  <div class="text-center p-3 text-warning">
    © 2020 Copyright |
    <a class="text-warning" href="https://github.com/yogeshgiri904">Azizbek Jumanazarov</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
